...
'''
docker run -it --rm --platform=linux/amd64 --network none --gpus all -v "/home/o644l/projects/panther/_test/input:/input" -v "/home/o644l/projects/panther/_test/output:/output" --entrypoint "" panther-dkfz-task1 /bin/bash
docker run -it --rm --platform=linux/amd64 --network none --gpus all -v "/home/o644l/projects/panther/_test/input:/input" -v "/home/o644l/projects/panther/_test/output:/output" panther-dkfz-task1
'''
...
# LOCAL TEST
MRI_INPUT_PATH = Path("/input/images/abdominal-t1-mri/")
OUTPUT_PATH = Path("/output/images/pancreatic-tumor-segmentation/")

RESOURCE_PATH = Path("_model/task1")
