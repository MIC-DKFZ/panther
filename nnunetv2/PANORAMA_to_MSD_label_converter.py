...
def remap_single_file(input_filename, input_folder, output_folder):
    ...
    try:
        ...
        # All other labels (2, 3, 6) are implicitly left as background (0)
        # because the new_data array was initialized with zeros.

        # Create a new NIfTI image with the new data
...
if __name__ == "__main__":
    ...
    input_directory = "../nnUNet_raw/Dataset147_PANORAMA/labelsTr"
    # The folder where the new .nii.gz files will be saved
    output_directory = "../nnUNet_raw/Dataset147_PANORAMA/labelsTr_fixed"
